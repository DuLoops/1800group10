        ...
        .then(function (snap) {
            snap.forEach(function (doc) {
                ...
                if(doc.id == userID){
                    ...
                    document.getElementById("reviews").innerHTML += "<div class='item'><small>Gym: "+gymName+"</small><div class = 'item-content'><h3>" + doc.data().title + "</h3>" + "<p>" + doc.data().text + "</p>" + getStars(doc.data().rating) + "</div></div>";
                }
            });
        });
}